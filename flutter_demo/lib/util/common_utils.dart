...
import 'package:flutter_demo/util/gsy_string_base.dart';
import 'package:flutter_demo/util/gsy_style.dart';
...
//  builder: (BuildContext context) {
//  return AlertDialog(
//  title: new Text(getLocale.getLocale(context).app_version_title),
